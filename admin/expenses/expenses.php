...
if (isset($_POST['add'])) {
    ...
    // ✅ SAFE REDIRECT FOR INCLUDED DASHBOARD PAGES
    echo "
    <script>
        window.location='?tab=expenses&month=".$month."';
    </script>
    ";
